...
// Generic for most instruments I would think... so does AI
static const float freqs_map[] = {
    0.0, 20.0, 31.0, 41.2, 65.4, 110.0, 440.0, 1000.0, 3000.0, 10000.0, 20000.0, -1.0
};
static const float weight_map[] = {
    -90.0, -30.0, 2.0, 5.0, 5.0, 5.0, 5.0, 3.0, 0.0, -20.0, -90.0
};
